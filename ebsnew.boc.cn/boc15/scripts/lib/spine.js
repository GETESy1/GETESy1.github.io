(function() {
    ...
    Model = (function(_super) {
        ...
        Model.prototype.bind = function(events, callback) {
            var binder, unbinder, _this = this;
    ...
    Controller = (function(_super) {
        ...
        Controller.prototype.delegateEvents = function(events) {
            var eventName, key, match, method, selector, _results, _this = this;
            _results = [];
            for (key in events) {
                method = events[key];
    ...
    $ = (typeof window !== "undefined" && window !== null ? window.$ : void 0) || (typeof window !== "undefined" && window !== null ? window.Zepto : void 0) || function(element) {
        return element
    };
...
(function() {
    var $, Spine, __hasProp = {}.hasOwnProperty,
        __extends = function(child, parent) {
            for (var key in parent) {
                if (__hasProp.call(parent, key)) child[key] = parent[key]
            }
    ...
    Spine.Stack = (function(_super) {
        ...
        function Stack() {
            var key, value, _fn, _ref, _ref1, _this = this;
...
(function() {
    var $, Ajax, Base, Collection, Extend, Include, Model, Singleton, Spine, __bind = function(fn, me) {
            return function() {
                return fn.apply(me, arguments)
            }
        },
...
(function() {
    var $, Spine, escapeRegExp, hashStrip, namedParam, splatParam, __hasProp = {}.hasOwnProperty,
        __extends = function(child, parent) {
            for (var key in parent) {
                if (__hasProp.call(parent, key)) child[key] = parent[key]
            }
